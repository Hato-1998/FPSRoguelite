...
"%ENGINE%" "%PROJDIR%\FPSRoguelite.uproject" -nullrhi -unattended -nosplash -ExecCmds="py %PROJDIR%\Scripts\verify_crit1_content.py,QUIT_EDITOR" -stdout -FullStdOutLogOutput -abslog=%PROJDIR%\Saved\verify_crit1.log
