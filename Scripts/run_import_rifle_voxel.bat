@echo off
REM Voxel rifle import -- headless REAL editor (Troubleshooting D1-b).
...
"%ENGINE%" "%PROJDIR%\FPSRoguelite.uproject" -nullrhi -unattended -nosplash -ExecCmds="py %PROJDIR%\Scripts\import_rifle_voxel.py" -stdout -FullStdOutLogOutput -abslog=%PROJDIR%\Saved\rifle_import.log
