...
REM The trailing ",QUIT_EDITOR" is REQUIRED or the editor never exits and the .bat never returns.
...
"%ENGINE%" "%PROJDIR%\FPSRoguelite.uproject" -nullrhi -unattended -nosplash -ExecCmds="py %PROJDIR%\Scripts\verify_stat1_content.py,QUIT_EDITOR" -stdout -FullStdOutLogOutput -abslog=%PROJDIR%\Saved\verify_stat1_content.log
