...
**핵심 제약 (모든 아키텍처 결정의 기준)**: 적을 **동시 ~200-300마리(실측 2026-07-01; 코드 폴백캡 300 부합, 하드캡 `MaxActiveEnemies`=500은 헤드룸) 싸게** 굴려야 한다 — **액터당 비용 최소화가 다른 모든 편의보다 우선**한다.
