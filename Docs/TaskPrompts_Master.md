...
| F2 | 〃 | **FF 최종 정책 = 🙋사용자 결정 대기**: Codex 권고 "기본 전면 **비치명 FF**(HP 1 클램프·25~35%·고의 FF 자동감쇠·다운직전 추가감쇠), 치명 50%=**Hazard급 옵션**" vs 현 SSOT "치명 50% 기본". "관통/AOE만 치명"=Codex 기각(빌드 위축) | 🙋사용자결정 | Concept §1-C-6·Enemy §2-10 | ⚠️결정 대기(현 SSOT와 상충) |
...
| F7 | 〃 | **FF→회복 카드 제약**: 오버힐 없음·틱 상한·다운직전 세이브 용도(지속 힐건化 금지). 협동 유도 가성비 순위 = 스페셜 적 > 어그로 룰/카드 > FF→회복 카드 | 콘텐츠(제약) | CombatWeaponCard §2-3 | 신규 |
