...
```
[1차 — 게임 플로우 완성 트랙]
V0 무기 비주얼 베이스 ∥ V1 사각 경고 오디오 ∥ U16 스핀업 LMG(가속 연사 무기)   (병행 가능, 서로 독립)
        ↓
...
| U16 | 스핀업 LMG(연사속도 가속 기관총) — 새 무기 1종 | C++/콘텐츠 | — (1차 트랙 병행, V0/V1 옆) | U1(손맛 평가 포함), W1(검증 포함) | `phase/p4c-spinup-lmg` |
