...
- 도메인 C(적): Docs/AssetWork_CharEnv_Resume.md(VAT 베이크 레시피·DataAsset 필드·UAnimToTextureBPLibrary/UAnimToTextureDataAsset API=기존 VAT 계약 SSOT), Docs/SSOT/Performance.md §5/§5-1(Significance S0~S3)/§5-2(플로우필드), Docs/SSOT/Enemy.md §2-6(스웜 적 렌더=인스턴싱/VAT+거리LOD), Docs/SSOT/Roadmap.md §8(큐브→VAT 교체 착수됨).
