...
| ✅U2 | 패배 배선: 간이 전멸 판정→EndRun(Defeat) — **완료(main 머지, 2026-06-16)**: PlayerState `bIsDead`(복제)+GameMode 독립집계+사망 입력/공격 차단+적/XP 시체제외. PIE 통과 | C++ | — | U3, U9, U11 | `phase/p6-defeat-wiring` |
