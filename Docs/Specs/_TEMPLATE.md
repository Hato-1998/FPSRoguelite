...
| 4 | 레드팀 게이트 | `Workflow.md` §6-6-1 — Fable 레드팀 서브에이전트(프라이머 `Docs/InternalRedTeamReview.md`)에 **diff + 이 명세만** 주고 리뷰. **P1 잔존 시 머지 금지** / P2는 수정 또는 근거 있는 기각 / P3는 후속. 지적과 처리 결과(수용·기각+근거)를 아래 §13에 남긴다 |
