...
| **DBNO** | 시점만(+크롤 결정 §6) | **크롤 30%** 또는 정지(§6) | **불가**(StopFiring/CancelAll) | **대상 X** | **무피해**(다운중) | 1P 다운(낮은 시점) |
...
1. **다운 이동**: **크롤(이동 30%, 점프/대시/사격 차단)** vs 완전 정지. (결정문에 "다운 이동" 명시 → 크롤 추천: 다운자가 위험지대 탈출/아군 접근 가능, 협동 긴장 유지.)
