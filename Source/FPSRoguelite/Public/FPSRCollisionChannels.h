 ...
 * gridlocks a dense crowd — Game.MD §1/§5) while STILL blocking the player (surround, and the collision-ignore
 * pass-through windows of §2-13), the PLAYER is given this distinct object type. Enemies then set their ECC_Pawn
 * response to Ignore (ignoring each other) while their default Block response keeps them blocking PlayerPawn and walls.
 *
