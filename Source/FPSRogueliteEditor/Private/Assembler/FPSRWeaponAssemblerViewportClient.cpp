...
const FString& FFPSRWeaponAssemblerViewportClient::GetArmsStatusMessage() const
{
	...
	if (ArmsAttachIssue.IsEmpty())
	{
		CachedArmsStatusMessage = ArmsPoseIssue;
	}
	else if (ArmsPoseIssue.IsEmpty())
	{
		CachedArmsStatusMessage = ArmsAttachIssue;
	}
	else
	{
		CachedArmsStatusMessage = ArmsAttachIssue + TEXT(" / ") + ArmsPoseIssue;
	}
